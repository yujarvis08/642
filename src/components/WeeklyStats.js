...
const WeeklyStats = () => {
    ...
    function createData(nutrient, amount) {
      ...
      const rows = [
        createData("Carbohydrates", 299.3),
        createData("Fat", 48.2),
        createData("Saturated Fat", 15.9),
        createData("Sugar", 58.6),
        createData("Sodium", 20.5),
        createData("Protein", 55.1),
        createData("Vitamin A", 0.00092),
        createData("Vitamin C", 0.11),
        createData("Fiber", 33.8),
        createData("Potassium", 3.9),
        createData("Zinc", 0.007),
      ];
        ...
        <Table className={classes.table} aria-label="simple table">
          <TableHead>
            <TableRow>
              ...
              Average Consumption This Past Week&nbsp;(g)
              </TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
